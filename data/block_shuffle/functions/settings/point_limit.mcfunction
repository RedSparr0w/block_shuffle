...
execute if score #point_limit bs.settings matches 20 run scoreboard players set #point_limit bs.settings 2
execute if score #point_limit bs.settings matches 10 run scoreboard players set #point_limit bs.settings 1
